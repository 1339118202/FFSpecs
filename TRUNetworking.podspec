...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yuanyuan.li-ext/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yuanyuan.li-ext' => 'yuanyuan.li-ext@ikang.com' }
  s.source           = { :git => 'https://github.com/yuanyuan.li-ext/TRUNetworking.git', :tag => s.version.to_s }
